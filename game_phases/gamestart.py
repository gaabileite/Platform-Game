...
bg_gamestart = pygame.transform.scale(pygame.image.load('assets/backgrounds/bg_start.png'), (960, 540))
btn_play = pygame.transform.scale(pygame.image.load('assets/backgrounds/btn-jogar.png'), (261, 69))
...
def gamestart(surface, player, enemies, death, platforms, shots, game_manager, flag, camera):
    ...
    btn_pulsante = pygame.transform.scale(btn_play, (int(261 * escala), int(69 * escala)))
    rect_pulsante  = btn_pulsante.get_rect(center=(480, 384))
